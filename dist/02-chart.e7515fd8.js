...
module.exports = "/railway.b2060d56.topojson";
...
function ready(_ref) {
  ...
  svg.append('path').datum({
    type: 'Sphere'
  }).attr('d', path).attr('class', 'sphere').attr('fill', '#a3cdd6').attr('stroke', 'black').attr('stroke-width', 2);
  ...
  function render() {
    console.log('Rendering'); // Calculate height/width
    ...
    actualSvg.attr('height', newHeight + margin.top + margin.bottom).attr('width', newWidth + margin.left + margin.right); // Update scales (depends on your scales)
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","debounce":"../node_modules/debounce/index.js","./data/world.topojson":"data/world.topojson","./data/railway.topojson":"data/railway.topojson"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","02-chart.js"], null)
//# sourceMappingURL=/02-chart.e7515fd8.map