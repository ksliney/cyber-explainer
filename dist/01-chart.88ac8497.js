...
function ready(datapoints) {
  ...
  svg.selectAll('.instrument').data(datapoints).enter().append('rect').attr('class', 'instrument').attr('y', function (d) {
    return yPositionScale(d.instrument);
  }).attr('x', 0).attr('height', yPositionScale.bandwidth()).attr('width', 0).attr('fill', '#67bea2');
  ...
  svg.selectAll('.gender-label').data(labels).enter().append('text').attr('class', 'gender-label').attr('y', yPositionScale('Flute')).attr('x', function (d) {
    return d === 'Women' ? 10 : width - 10;
  }).attr('text-anchor', function (d) {
    return d === 'Women' ? 'start' : 'end';
  }).attr('fill', 'white').attr('alignment-baseline', 'middle').attr('font-size', 18).attr('dy', yPositionScale.bandwidth() / 2 + 2).text(function (d) {
    return d;
  });
  ...
  d3.select('#instruments-mentioned').on('stepin', function () {
    ...
    svg.selectAll('.instrument-bg').transition().attr('fill', function (d) {
      var instruments = ['Bassoon', 'Double Bass', 'Timpani']; // The ugly JavaScript way to say
      // "is this in my list?"
  ...
  function render() {
    ...
    var newHeight = screenHeight - margin.top - margin.bottom; // Update your SVG
    ...
    }).attr('dy', yPositionScale.bandwidth() / 2 + 2); // If it's reaaaal small, resize the text
...
},{"d3":"../node_modules/d3/index.js","./data/orchestras.csv":"data/orchestras.csv"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","01-chart.js"], null)
