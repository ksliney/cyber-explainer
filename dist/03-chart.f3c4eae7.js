...
var nyc = [-74, 40];
var sf = [-122, 37];
var golog = [100.2448, 34.4714];
var beijing = [116.4074, 39.9042];
var russia_center = [92.8932, 56.0153];
var tehran = [51.3890, 35.6892];
var pyongyang = [125.7625, 39.0392];
...
function ready(json) {
  ...
  svg.append('path').datum({
    type: 'Sphere'
  }).attr('d', path).attr('class', 'sphere').attr('fill', '#202226'); // .attr('stroke', 'black')
  // .attr('stroke-width', .3)

  svg.append('g').selectAll('.country').data(countries.features).enter().append('path').attr('class', 'country').attr('d', path).attr('fill', 'white').attr('stroke', 'black').attr('stroke-width', 0.1);
  d3.select('#step-russia').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-russia_center[0], -russia_center[1]];
  ...
  d3.select('#step-iran').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-tehran[0], -tehran[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
        var currentRotation = rotationInterpolator(t);
        projection.rotate(currentRotation);
  ...
  d3.select('#step-nk').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-pyongyang[0], -pyongyang[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
        var currentRotation = rotationInterpolator(t);
        projection.rotate(currentRotation);
  ...
  d3.select('#step-china').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-golog[0], -golog[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
        var currentRotation = rotationInterpolator(t);
        projection.rotate(currentRotation);
...
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","./data/world.topojson":"data/world.topojson"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","03-chart.js"], null)
//# sourceMappingURL=/03-chart.f3c4eae7.map